...

{
	...
	*/
	...
	bankAccount *arrayOfPointers[2];

	float trans1[3] = {3000, 5000, 60000};
	arrayOfPointers[0] = new bankAccount(30,2000, trans1, 3);  

	arrayOfPointers[1] = new bankAccount(40, 255000, 400000);

	//	arrayOfPointers[0] -> print();
	//	arrayOfPointers[1] -> print();
	...
	*/
	...
	//*****Write your code here
	*/
	bankAccount **dyArrOfPointers = new bankAccount*[2];

	float trans2[2] = {-2000, 2000};
	dyArrOfPointers[0] = new bankAccount(50, 2000, trans2, 2);

	dyArrOfPointers[1] = new bankAccount(60, 6000, 400000);

	//	dyArrOfPointers[0] -> print();
	//	dyArrOfPointers[1] -> print();
	...
	*/
	...
	for(int i = 0; i < 2 ; i++)
	{
		delete dyArrOfPointers[i] ;
	}
	delete [] dyArrOfPointers;
	...
	*/
	...
	bankAccount **storePtr;
	int s =0;
	storePtr = readFile("data.txt", s);
...
bankAccount** readFile(string inFile, int& size)
{
	...
	bankAccount **dyArrOfPointers = new bankAccount*[noOfAccs];


	//defining local variables for reading
	int ID;
	float balance; 
	float balanceLimit;
	int noOfTran;
	...
	for( int i = 0; i < noOfAccs; i++)
	{
		...
		transactions = new float[noOfTran];
		...
		dyArrOfPointers[i] = new bankAccount(ID, balance, transactions, noOfTran, balanceLimit);  
	...
	return dyArrOfPointers;

}

void printAccounts(bankAccount** bo, int size)
{
